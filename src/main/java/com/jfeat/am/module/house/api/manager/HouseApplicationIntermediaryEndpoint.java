 ...
 */
@RestController
@Api("HouseApplicationIntermediary")
@RequestMapping("/api/crud/house/houseApplicationIntermediary/houseApplicationIntermediaryies")
public class HouseApplicationIntermediaryEndpoint {
    ...
    @BusinessLog(name = "HouseApplicationIntermediary", value = "create HouseApplicationIntermediary")
    @Permission(HouseApplicationIntermediaryPermission.HOUSEAPPLICATIONINTERMEDIARY_NEW)
    @PostMapping
    @ApiOperation(value = "新建 HouseApplicationIntermediary", response = HouseApplicationIntermediary.class)
    ...
    @Permission(HouseApplicationIntermediaryPermission.HOUSEAPPLICATIONINTERMEDIARY_VIEW)
    @GetMapping("/{id}")
    @ApiOperation(value = "查看 HouseApplicationIntermediary", response = HouseApplicationIntermediary.class)
    ...
    @BusinessLog(name = "HouseApplicationIntermediary", value = "update HouseApplicationIntermediary")
    @Permission(HouseApplicationIntermediaryPermission.HOUSEAPPLICATIONINTERMEDIARY_EDIT)
    @PutMapping("/{id}")
    @ApiOperation(value = "修改 HouseApplicationIntermediary", response = HouseApplicationIntermediary.class)
    public Tip updateHouseApplicationIntermediary(@PathVariable Long id, @RequestBody HouseApplicationIntermediary entity) {
        entity.setId(id);
        return SuccessTip.create(houseApplicationIntermediaryService.updateMaster(entity));
    }

    @BusinessLog(name = "HouseApplicationIntermediary", value = "delete HouseApplicationIntermediary")
    @Permission(HouseApplicationIntermediaryPermission.HOUSEAPPLICATIONINTERMEDIARY_DELETE)
    @DeleteMapping("/{id}")
    @ApiOperation("删除 HouseApplicationIntermediary")
    public Tip deleteHouseApplicationIntermediary(@PathVariable Long id) {
        return SuccessTip.create(houseApplicationIntermediaryService.deleteMaster(id));
    }

    @Permission(HouseApplicationIntermediaryPermission.HOUSEAPPLICATIONINTERMEDIARY_VIEW)
    @ApiOperation(value = "HouseApplicationIntermediary 列表信息", response = HouseApplicationIntermediaryRecord.class)
    @GetMapping
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "organization", dataType = "String"),
            ...
            @ApiImplicitParam(name = "signFlag", dataType = "Integer"),
