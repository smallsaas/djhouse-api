...
public class HouseUserDecorateAddressEndpoint {
    ...
    @GetMapping("/{id}")
    @ApiOperation(value = "查看 HouseUserDecorateAddress", response = HouseUserDecorateAddress.class)
    ...
    @DeleteMapping("/{id}")
    @ApiOperation("删除 HouseUserDecorateAddress")
    ...
    @Permission(HouseUserDecorateAddressPermission.HOUSEUSERDECORATEADDRESS_VIEW)
    @ApiOperation(value = "HouseUserDecorateAddress 列表信息", response = HouseUserDecorateAddressRecord.class)
    @GetMapping
    @ApiImplicitParams({
