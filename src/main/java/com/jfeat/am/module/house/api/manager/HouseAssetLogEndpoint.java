...
@RestController
@Api("HouseAssetLog")
@RequestMapping("/api/crud/house/houseAssetLog/houseAssetLogs")
public class HouseAssetLogEndpoint {
    ...
    @Permission(HouseAssetLogPermission.HOUSEASSETLOG_NEW)
    @PostMapping
    ...
    @Permission(HouseAssetLogPermission.HOUSEASSETLOG_VIEW)
    @GetMapping("/{id}")
    ...
    @Permission(HouseAssetLogPermission.HOUSEASSETLOG_EDIT)
    @PutMapping("/{id}")
    ...
    @Permission(HouseAssetLogPermission.HOUSEASSETLOG_DELETE)
    @DeleteMapping("/{id}")
