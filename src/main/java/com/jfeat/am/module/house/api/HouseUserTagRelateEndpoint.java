 ...
 */
@RestController
@Api("HouseUserTagRelate")
@RequestMapping("/api/crud/house/houseUserTagRelate/houseUserTagRelates")
public class HouseUserTagRelateEndpoint {
    ...
    @BusinessLog(name = "HouseUserTagRelate", value = "create HouseUserTagRelate")
    @Permission(HouseUserTagRelatePermission.HOUSEUSERTAGRELATE_NEW)
    @PostMapping
    @ApiOperation(value = "新建 HouseUserTagRelate", response = HouseUserTagRelate.class)
    ...
    @Permission(HouseUserTagRelatePermission.HOUSEUSERTAGRELATE_VIEW)
    @GetMapping("/{id}")
    @ApiOperation(value = "查看 HouseUserTagRelate", response = HouseUserTagRelate.class)
    ...
    @BusinessLog(name = "HouseUserTagRelate", value = "update HouseUserTagRelate")
    @Permission(HouseUserTagRelatePermission.HOUSEUSERTAGRELATE_EDIT)
    @PutMapping("/{id}")
    @ApiOperation(value = "修改 HouseUserTagRelate", response = HouseUserTagRelate.class)
    ...
    @BusinessLog(name = "HouseUserTagRelate", value = "delete HouseUserTagRelate")
    @Permission(HouseUserTagRelatePermission.HOUSEUSERTAGRELATE_DELETE)
    @DeleteMapping("/{id}")
    @ApiOperation("删除 HouseUserTagRelate")
    ...
    @Permission(HouseUserTagRelatePermission.HOUSEUSERTAGRELATE_VIEW)
    @ApiOperation(value = "HouseUserTagRelate 列表信息", response = HouseUserTagRelateRecord.class)
    @GetMapping
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "tagId", dataType = "Long"),
