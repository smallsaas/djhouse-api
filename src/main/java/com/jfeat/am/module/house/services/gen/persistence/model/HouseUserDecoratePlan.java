...
public class HouseUserDecoratePlan extends Model<HouseUserDecoratePlan> {
    ...
    public HouseUserDecoratePlan setDecorateAddress(String decorateAddress) {
    ...
    public String getNote() {
      ...
      public static final String DECORATE_ADDRESS = "decorate_address";
    ...
    public String toString() {
        return "HouseUserDecoratePlan{" +
                ...
                ", note='" + note + '\'' +
                ", decorateAddress='" + decorateAddress + '\'' +
                '}';
    }
}
