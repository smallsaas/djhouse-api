...
public class HousePropertyBuildingUnitEndpoint {
    ...
    @BusinessLog(name = "HousePropertyBuildingUnit", value = "init HousePropertyBuildingUnit")
    @PostMapping("/init")
    @ApiOperation("初始化 initHousePropertyBuildingUnit")
    public Tip initHousePropertyBuildingUnit() {
        return SuccessTip.create(housePropertyBuildingUnitService.initBuildingUnit());
    }
}
